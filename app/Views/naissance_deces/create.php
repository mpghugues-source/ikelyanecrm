...
<form method="POST" action="/admin/naissance-deces/store">
    <?= csrf_field() ?>
    <div class="row g-3">
        <div class="col-md-4">
            ...
            <select name="type_evenement" class="form-select" required>
                <option value="naissance" <?= old('type_evenement') == 'naissance' ? 'selected' : '' ?>><?= lang('NaissanceDeces.birth') ?></option>
                <option value="deces" <?= old('type_evenement') == 'deces' ? 'selected' : '' ?>><?= lang('NaissanceDeces.death') ?></option>
            </select>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            ...
            <input type="text" name="prenom" class="form-control" value="<?= esc(old('prenom')) ?>">
        </div>
        <div class="col-md-4">
            <label class="form-label"><?= lang('NaissanceDeces.date') ?> <span class="text-danger">*</span></label>
            <input type="date" name="date_evenement" class="form-control" value="<?= esc(old('date_evenement', date('Y-m-d'))) ?>" required>
        </div>
        <div class="col-md-4">
            <label class="form-label"><?= lang('NaissanceDeces.time') ?></label>
            <input type="time" name="heure_evenement" class="form-control" value="<?= esc(old('heure_evenement')) ?>">
        </div>
        <div class="col-md-4">
            <label class="form-label"><?= lang('NaissanceDeces.place') ?></label>
            <input type="text" name="lieu" class="form-control" value="<?= esc(old('lieu')) ?>">
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="numero_certificat" class="form-control" value="<?= esc(old('numero_certificat')) ?>">
        </div>
        <div class="col-12">
