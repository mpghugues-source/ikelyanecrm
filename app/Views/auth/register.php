...
<head>
    ...
    <title><?= esc($title ?? lang('Auth.register_title') . ' — IkelyaneCRM') ?></title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap" rel="stylesheet">
    <style>
        * { font-family: 'Inter', sans-serif; }
        body { background: linear-gradient(135deg, #052e16 0%, #064e3b 100%); min-height: 100vh; display: flex; align-items: center; }
        .register-card { background: #fff; border-radius: 24px; box-shadow: 0 30px 80px rgba(0,0,0,0.3); border: none; overflow: hidden; }
        .register-left { background: linear-gradient(135deg, #059669, #f97316); padding: 48px 40px; display: flex; flex-direction: column; justify-content: center; }
        ...
        .feature-item i { font-size: 1.1rem; color: #6ee7b7; flex-shrink: 0; }
        ...
        .form-control:focus, .form-select:focus { border-color: #059669; box-shadow: 0 0 0 3px rgba(5,150,105,0.15); }
        .btn-register { background: linear-gradient(135deg, #059669, #f97316); border: none; border-radius: 12px; padding: 13px; font-size: 1rem; font-weight: 700; color: #fff; width: 100%; transition: all .3s; }
        .btn-register:hover { opacity: .9; transform: translateY(-1px); box-shadow: 0 10px 30px rgba(5,150,105,.4); color: #fff; }
        ...
        .step-dot.active { background: #059669; width: 24px; border-radius: 4px; }
                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-5 register-left">
                        <a href="/" class="text-white text-decoration-none">
                            <div class="brand">IkelyaneCRM</div>
                        </a>
                        ...
                        <div class="mt-auto pt-4" style="border-top:1px solid rgba(255,255,255,0.2);margin-top:40px">
                            ...
                            <a href="/login" style="color:#6ee7b7;font-weight:600;text-decoration:none"><?= lang('Auth.login_btn') ?> →</a>
                        </div>
                    </div>
