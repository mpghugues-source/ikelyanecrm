...
<div class="page-header">
    <h4><i class="bi bi-gear text-primary me-2"></i>Paramètres de la clinique</h4>
</div>

<div class="row g-3">
    <div class="col-lg-7">
        <div class="card">
            <div class="card-header"><h6 class="card-title"><i class="bi bi-building me-2 text-primary"></i>Informations de la clinique</h6></div>
            <div class="card-body">
    ...
    <div class="col-lg-5">
        <div class="card mb-3">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h6 class="card-title mb-0"><i class="bi bi-receipt me-2 text-primary"></i>Services et actes médicaux</h6>
            ...
            <div class="collapse" id="addServiceForm">
                <div class="card-body border-bottom bg-light">
                    <form action="/admin/settings/services/add" method="POST" class="row g-2">
                        <?= csrf_field() ?>
                        <div class="col-7">
                            <input type="text" name="nom" class="form-control form-control-sm" placeholder="Nom du service" required>
                        </div>
                        <div class="col-3">
                            <input type="number" name="prix" class="form-control form-control-sm" placeholder="Prix (DA)" min="0" step="50" required>
                        </div>
                        <div class="col-2">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-sm mb-0">
                        <thead><tr><th>Service</th><th>Code</th><th>Prix</th><th></th></tr></thead>
                        <tbody>
        ...
        <div class="card">
            <div class="card-header"><h6 class="card-title"><i class="bi bi-award me-2 text-primary"></i>Spécialités médicales</h6></div>
            <div class="card-body">
