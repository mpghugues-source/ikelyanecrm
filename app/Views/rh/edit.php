...
<form method="POST" action="/admin/rh/<?= $employe['id'] ?>/update">
    <?= csrf_field() ?>
    <div class="row g-3">
        <div class="col-md-4">
            <label class="form-label"><?= lang('RH.name') ?> <span class="text-danger">*</span></label>
            <input type="text" name="nom" class="form-control" value="<?= esc(old('nom', $employe['nom'])) ?>" required>
        </div>
        <div class="col-md-4">
            <label class="form-label"><?= lang('RH.firstname') ?> <span class="text-danger">*</span></label>
            <input type="text" name="prenom" class="form-control" value="<?= esc(old('prenom', $employe['prenom'])) ?>" required>
        </div>
        <div class="col-md-4">
            <label class="form-label"><?= lang('RH.position') ?> <span class="text-danger">*</span></label>
            <input type="text" name="poste" class="form-control" value="<?= esc(old('poste', $employe['poste'])) ?>" required>
        </div>
        <div class="col-md-4">
            <label class="form-label"><?= lang('RH.department') ?></label>
            <input type="text" name="departement" class="form-control" value="<?= esc(old('departement', $employe['departement'])) ?>">
        </div>
        <div class="col-md-4">
            ...
            <select name="contrat" class="form-select">
                ...
                <option value="<?= $c ?>" <?= old('contrat', $employe['contrat']) == $c ? 'selected' : '' ?>><?= $c ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        <div class="col-md-4">
            <label class="form-label"><?= lang('RH.hire_date') ?></label>
            <input type="date" name="date_embauche" class="form-control" value="<?= esc(old('date_embauche', $employe['date_embauche'])) ?>">
        </div>
        <div class="col-md-4">
            <label class="form-label"><?= lang('RH.salary') ?> (DA)</label>
            <input type="number" step="0.01" name="salaire" class="form-control" value="<?= esc(old('salaire', $employe['salaire'])) ?>">
        </div>
        <div class="col-md-4">
            <label class="form-label"><?= lang('RH.phone') ?></label>
            <input type="text" name="telephone" class="form-control" value="<?= esc(old('telephone', $employe['telephone'])) ?>">
        </div>
        <div class="col-md-4">
            <label class="form-label"><?= lang('RH.email') ?></label>
            <input type="email" name="email" class="form-control" value="<?= esc(old('email', $employe['email'])) ?>">
        </div>
        <div class="col-12">
            <label class="form-label"><?= lang('RH.notes') ?></label>
            <textarea name="notes" class="form-control" rows="3"><?= esc(old('notes', $employe['notes'])) ?></textarea>
        </div>
