...
class CreateErpTables extends Migration
{
    public function up(): void
    {
        ...
        $this->forge->addField([
            ...
            'ice'                 => ['type' => 'VARCHAR', 'constraint' => 50, 'null' => true],
        ...
        $this->forge->addField([
            ...
            'emplacement'      => ['type' => 'VARCHAR', 'constraint' => 100, 'null' => true],
        ...
        $this->forge->addField([
            ...
            'tenant_id'   => ['type' => 'INT', 'null' => false],
            'item_id'     => ['type' => 'INT'],
            'type'        => ['type' => 'ENUM', 'constraint' => ['in','out','adjustment','return'], 'default' => 'in'],
            'quantite'    => ['type' => 'DECIMAL', 'constraint' => '15,3'],
            'prix_unit'   => ['type' => 'DECIMAL', 'constraint' => '15,2', 'default' => 0],
            'reference'   => ['type' => 'VARCHAR', 'constraint' => 100, 'null' => true],
            'motif'       => ['type' => 'VARCHAR', 'constraint' => 200, 'null' => true],
            'notes'       => ['type' => 'TEXT', 'null' => true],
            'created_by'  => ['type' => 'INT', 'null' => true],
            'created_at'  => ['type' => 'DATETIME', 'null' => true],
        ]);
        $this->forge->addPrimaryKey('id');
        $this->forge->addKey(['tenant_id', 'item_id']);
        ...
        $this->forge->addField([
            ...
            'quantite'      => ['type' => 'DECIMAL', 'constraint' => '15,3'],
            'unite'         => ['type' => 'VARCHAR', 'constraint' => 30, 'default' => 'pièce'],
            'prix_unitaire' => ['type' => 'DECIMAL', 'constraint' => '15,2'],
            'tva'           => ['type' => 'DECIMAL', 'constraint' => '5,2', 'default' => 0],
            'montant_total' => ['type' => 'DECIMAL', 'constraint' => '15,2'],
            'quantite_recue'=> ['type' => 'DECIMAL', 'constraint' => '15,3', 'default' => 0],
        ]);
        $this->forge->addPrimaryKey('id');
        $this->forge->addKey('po_id');
        $this->forge->createTable('erp_purchase_order_items');

        // ── ERP ACCOUNTS (PLAN COMPTABLE) ─────────────────────────────
        $this->forge->addField([
            'id'          => ['type' => 'INT', 'auto_increment' => true],
            'tenant_id'   => ['type' => 'INT', 'null' => false],
        ...
        $this->forge->addField([
            ...
            'statut'              => ['type' => 'ENUM', 'constraint' => ['draft','validated','cancelled'], 'default' => 'draft'],
            'piece_jointe'        => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'notes'               => ['type' => 'TEXT', 'null' => true],
            'created_by'          => ['type' => 'INT', 'null' => true],
            'created_at'          => ['type' => 'DATETIME', 'null' => true],
            'updated_at'          => ['type' => 'DATETIME', 'null' => true],
        ...
        $this->forge->addField([
            ...
            'avancement'   => ['type' => 'TINYINT', 'default' => 0],
            'chef_projet'  => ['type' => 'INT', 'null' => true],
            'created_by'   => ['type' => 'INT', 'null' => true],
            'created_at'   => ['type' => 'DATETIME', 'null' => true],
            'updated_at'   => ['type' => 'DATETIME', 'null' => true],
        ]);
    ...
    {
        $this->forge->dropTable('erp_project_tasks', true);
        $this->forge->dropTable('erp_projects', true);
        $this->forge->dropTable('erp_budgets', true);
        $this->forge->dropTable('erp_transactions', true);
        $this->forge->dropTable('erp_accounts', true);
        $this->forge->dropTable('erp_purchase_order_items', true);
        $this->forge->dropTable('erp_purchase_orders', true);
        $this->forge->dropTable('erp_inventory_movements', true);
        $this->forge->dropTable('erp_inventory_items', true);
        $this->forge->dropTable('erp_suppliers', true);
    }
}
